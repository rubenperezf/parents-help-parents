...
function Help() {
  return (
    <div className="help-aboutUs-container">
      ...
      <p>
        Maecenas condimentum eros eget odio aliquam consectetur. Ut sed accumsan
        odio. Phasellus interdum eros libero, at iaculis orci cursus a. Sed
        hendrerit nibh in elit malesuada tincidunt. Lorem ipsum dolor sit amet,
        consectetur adipiscing elit. Mauris sit amet ullamcorper ante. Donec
        condimentum vel risus quis gravida. Maecenas sagittis ipsum id erat
        aliquet, ut posuere ante facilisis. Pellentesque ultrices justo et
        mauris interdum, id placerat enim vestibulum. Aenean laoreet quis nisi
        eget tristique. Aenean eget eros molestie, eleifend magna et, faucibus
        tortor. Nunc a sapien nunc. Sed molestie tincidunt commodo. Etiam quis
        elit ante.
      </p>
    </div>
  );
