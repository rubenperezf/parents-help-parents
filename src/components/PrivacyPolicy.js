    ...
    <div className="sitemap-privacy-container">
      ...
      <div className="privacy-parts">
        <p>
          ...
          www.parentshelpparents.com. We reserve the right to change this
          policy at any given time, of which you will be promptly updated. If
      ...
      <div className="privacy-parts">
        ...
        <p>
          Parents Help Parents is committed to securing your data and keeping it
          confidential. Parents help Parents has done all in its power to prevent data theft,
      ...
      <div className="privacy-parts">
        ...
        <p>
          ...
          Terms and conditions template by WebsitePolicies.com If you want to
          disable cookies, you can do it by accessing the settings of your
          internet browser. (Provide links for cookie settings for major
          internet browsers).
        </p>
      </div>
      <div className="privacy-parts">
        ...
        <p>
          ...
          on these links Parets help Parents is not held responsible for your data and
      ...
      <div className="privacy-parts">
        ...
        <p>
          ...
          more than happy to change this for you. Parents help Parents will not lease, sell or
